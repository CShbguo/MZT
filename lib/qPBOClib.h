 ...
 *
 *==========================================================================*/
#ifndef _H_QPBOCLIB_H
#define _H_QPBOCLIB_H

//需要打开  _debug_
//#define QPBOC_DEBUG
//#define QPBOC_DEBUG_ER
#ifdef	QPBOC_DEBUG_ER
...
extern unsigned char qpbocrevbuf[258];
extern unsigned char Tag5F34[10];
extern unsigned int PosTradeCout =1;
extern QPBOC_RESULT_TYPE TradeResult;
extern stPosOfferData PosOfferData;
...
extern char *BCD2ASC(unsigned char *strBCD, int lenBCD);
extern void get_BER_TVL(IN INT32U bitPos,OUT BER_TVL *OutTVL);
extern int Pro_QpbocInt(void);
extern int qPbocTradeProc(IN INT32U InputMoney,OUT INT32U *Len,OUT INT8U *pOutMsg);
extern int QpbocOfflineAuten(void);
//写银联记录用256字节。
extern unsigned char qPbocWriteRecord(unsigned char *rec);
extern unsigned char qPbocBuildRec(unsigned char *qrecbuff);
extern void Pboc_delay_card(void);
