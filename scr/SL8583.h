...
#define MAX_WHT_BANK_NUM 100		//白名单条数
...
typedef struct{
	...
	unsigned char Miss_ver[2];//下载版本号 低在前
...
typedef struct{	//文件列表
	unsigned char filename[4];		//文件类型
	unsigned char fileVer2[8];		//文件子版本
	unsigned int fileVer;			//终端显示文件版本
