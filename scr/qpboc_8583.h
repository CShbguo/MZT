...
#if 1
#define		TPDU	"6000090000"	// 绵州银联
#else
#define		TPDU	"600138000"	// 湖南银联测试TPDU
#endif

#if 0
#define		HEAD	"613200324605"		// 上海银联
#else
#define		HEAD	"603100311005"//"603100338176"		// 绵州银联
#endif
...
#define MISS_PBOC_UPREC_ca	 0x28	//ODA上传记录
...
typedef struct {
	...
	unsigned char reserver[6];//保留
	unsigned char CrcCheck[4];//32位CRC校验
}stMobileParameter;//中心下发的参数缓冲结构  64
...
mode=6:同时设置1、2、3
*/
extern void saveMobileParameter(unsigned char mode, unsigned char *buf);
/*
mode=1: shopNo[15];//商户编号
...
extern void mzt_qpoc_init(void);
extern void cls_repurse(void);
