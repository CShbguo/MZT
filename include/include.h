...
extern volatile unsigned int XF_Sound_dly;  
extern volatile unsigned int sound_dly;
...
#define FLASH_PBOC_PARA		0x1A5000
#define FLASH_CACERT		0x1A6000
#define FLASH_CACERT_BACKUP		0x1A7000
//直到0x1B0000 还没有用
//直到0x1B0000 还没有用
...
#define FLASH_TEMP_END		0x1D0000	//-0x1D0000 临时数据存贮区　128K 

#define FLASH_GPS_LINE_START 0x1D0000	//GPS 线路信息开始 128K
#define FLASH_GPS_LENE_VER	 0x1DFFC0	//总包的版本号，存在后64字节处, 包括线路、限速、广告
#define FLASH_GPS_LENE_END	 0x1E0000	//GPS 线路信息结束 

#define FLASH_GPS_SOUND_START 0x1E0000	//GPS 语音开始 64K
#define FLASH_GPS_SOUND_END	  0x1F0000	//GPS 语音结束

#define FLASH_PUBLICKEY_START	0x1F0000	//软件算RSA，保存公钥区。32K
#define FLASH_PUBLICKEY_END		0x1F8000

#define FLASH_BLK_START 0x200000//黑名单空间：64K 65536 每块4K
#define FLASH_BLK_END	0x220000//64k  共128k



#define FLASH_WHITE_START 0x3B0000//城市互联互通城市名单空间：4K    前面6字节传“有效”和长度2字节，高位在前
#define FLASH_WHITE_END	0x3B1000
